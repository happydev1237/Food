                    ...
                    <div className={hstyles.container}>
                        <div className={hstyles.navbar}>
                            ...
                            <div className={hstyles.flex} style={{paddingRight: 20}}>
                                <h1 className={hstyles.stitle}> AzizStark </h1>&nbsp;&nbsp;&nbsp;
                        ...
                        {this.state.conta.hotelnames.map((data, index) =>
                            <div className={hstyles.card} key={index} onClick={() => this.gotoOrder(data.hotel)}>
                        ...
                        <div className={hstyles.navfoo}>
                            <h4 className={hstyles.navtitle}> Designed and developed by AzizStark</h4>
                        </div>
                    </div>
            </div>
        )
